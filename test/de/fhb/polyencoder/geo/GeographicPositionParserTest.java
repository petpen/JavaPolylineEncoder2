...
public class GeographicPositionParserTest {
  ...
  @Test
  public void testFloor1e5ValidLatitudes() {
    try {
      assertEquals("The latitude 0.0 must be 0 after the method call",0,GeographicPositionParser.floor1e5(0.0,GeographicCoordinate.LATITUDE));
      assertEquals("The latitude 90.0 must be 9000000 after the method call",9000000,GeographicPositionParser.floor1e5(90.0,GeographicCoordinate.LATITUDE));
      assertEquals("The latitude -90.0 must be -9000000 after the method call",-9000000,GeographicPositionParser.floor1e5(-90.0,GeographicCoordinate.LATITUDE));
  ...
  public void testFloor1e5AboveRangeLatitude() throws CoordinateOutOfRangeException {
    GeographicPositionParser.floor1e5(90.000001, GeographicCoordinate.LATITUDE);
  }



  @Test (expected = CoordinateOutOfRangeException.class)
  public void testFloor1e5UnderRangeLatitude() throws CoordinateOutOfRangeException {
    GeographicPositionParser.floor1e5(-90.000001, GeographicCoordinate.LATITUDE);
  }
  ...
  @Test
  public void testFloor1e5ValidLongitudes() {
    try {
      assertEquals("The latitude 0.0 must be 0 after the method call",0,GeographicPositionParser.floor1e5(0.0,GeographicCoordinate.LONGITUDE));
      assertEquals("The latitude 180.0 must be 18000000 after the method call",18000000,GeographicPositionParser.floor1e5(180.0,GeographicCoordinate.LONGITUDE));
      assertEquals("The latitude -179.999990 must be -17999999 after the method call",-17999999,GeographicPositionParser.floor1e5(-179.999990,GeographicCoordinate.LONGITUDE));
      assertEquals("The latitude -179.999999 must be -17999999 after the method call",-17999999,GeographicPositionParser.floor1e5(-179.999999,GeographicCoordinate.LONGITUDE));
    } catch (CoordinateOutOfRangeException e) {
      fail(e.getMessage());
    }
  }
  ...
  @Test (expected = CoordinateOutOfRangeException.class)
  public void testFloor1e5AboveRangeLongitude() throws CoordinateOutOfRangeException {
    GeographicPositionParser.floor1e5(180.000001, GeographicCoordinate.LONGITUDE);
  }



  @Test (expected = CoordinateOutOfRangeException.class)
  public void testFloor1e5UnderRangeLongitude() throws CoordinateOutOfRangeException {
    GeographicPositionParser.floor1e5(-180.0, GeographicCoordinate.LONGITUDE);
  }
}

...
public class EncodersResourceTest extends JerseyTest {
  ...
  private static final String DEFAULT_COORDS_GPX_ENCODED_POINTS = "_qo]_qo]~hbE_ibE_}hQ_seK";
  private static final String DEFAULT_COORDS_GPX_ENCODED_LEVELS = "PPP";
